              ...
              <td>
                <div class="goods">
                  ...
                  <div>
                    ...
                    <!-- 选择规格组件 -->
                    <CartSku @change="$event => updateCartSku(goods.skuId, $event)" :skuId="goods.skuId"
                      :attrsText="goods.attrsText"></CartSku>
                  </div>
                </div>
              </td>
              <td class="tc">
                <p>&yen;{{ goods.nowPrice }}</p>
                <p v-if="goods.price - goods.nowPrice > 0">比加入时降价 <span class="red">&yen;{{
